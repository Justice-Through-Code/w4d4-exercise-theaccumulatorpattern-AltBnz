...
'''
#This code was written collaboratively in the group pod with Christian Toro, Jay 
...
def calculate_average_temperature(temperatures: List[float]) -> float:
    ...
    sum_of_temps = 0
    # temperatures = [-10.0, 0.0, 10.0, 20.0, 30.0, 40.0, 40.0]
    ...
    return sum_of_temps / len(temperatures)
    
    # 1.3 TODO: return the average temperature
    

calculate_average_temperature(temperatures = [-10.0, 0.0, 10.0, 20.0, 30.0, 40.0, 40.0])
